...
$sqlProducts = "SELECT * FROM animal WHERE `age` > 8";
...
<hr>
    <div class='but'>
        <a href='pet/details_user.php?id={$rowProduct["id"]}' class='button7 mx-2'>MORE ABOUT ME
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item mx-2"> <a class="nav-link text-white btn4" href="home.php">ALL PETS</a></li>
                    <li class="nav-item">
